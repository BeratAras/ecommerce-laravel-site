    ...
    <div class="d-flex align-items-center justify-content-center bg-sl-primary ht-100v">
        ...
        <form action="{{ route('admin.login') }}" method="POST">
            ...
            <div class="form-group">
                <input type="email" class="form-control" placeholder="E-Posta" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="E-Posta">
            </div><!-- form-group -->
            @error('email')
            ...
            <div class="form-group">
                ...
                @enderror
                <a href="{{ route('admin.password.request') }}" class="tx-info tx-12 d-block mg-t-10">Şifreni mi Unuttun?</a>
            </div><!-- form-group -->
